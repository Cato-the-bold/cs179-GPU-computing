...
/*************** END GAUSSIAN ******************/
    ...
    cudaMalloc((cufftComplex**)&dev_input_data, sizeof(cufftComplex) * padded_length);
    cudaMalloc((cufftComplex**)&dev_impulse_v, sizeof(cufftComplex) * padded_length);
    cudaMalloc((cufftComplex**)&dev_out_data, sizeof(cufftComplex) * padded_length);
...
#define STOP_RECORD_TIMER(name) {                           \
    ...
    for (int ch = 0; ch < nChannels; ch++){
        ...
        */
        cudaMemset(dev_input_data+N, 0 , sizeof(cufftComplex)*(impulse_length-1));
        cudaMemset(dev_impulse_v+impulse_length, 0 , sizeof(cufftComplex)*(N-1));
